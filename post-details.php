  ...
  if(isset($_POST['btn']))
    {
      if (isset($_GET['id'])) {
       ...
       $singleblogPosts->comments($id);
    }

    $Categories = new App\classes\Category;
    $all_categories = $Categories->readCategory();
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <div class="mt-4 h-20%">
             <h1>
                Post Title : <p><?php echo $singleRow['post_title']; ?></p>
              </h1>  
        ...
        <!-- Date/Time -->
        <p>Posted on <?php echo $singleRow['created_at'];?>PM</p>

        <hr>

        <!-- Preview Image -->
        <img class="img-fluid rounded" src="app/<?php echo $singleRow['image']; ?>" width="900" height ="300">

        <hr>

        <!-- Post Content -->
        <p class="lead"><?php echo $singleRow['short_description']; ?></p>
        ...
        <?php
           if (isset($_GET['id'])) {
            $post_id = $_GET['id'];
            $result = $singleblogPosts->showComments($post_id);
